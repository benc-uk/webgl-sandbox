...
export function getGl(selector = 'canvas', aa = true) {
  ...
  console.info(`📐 CREATE GL Canvas: ${canvas.width} x ${canvas.height}, display: ${canvas.clientWidth} x ${canvas.clientHeight}`)
...
export function resize(viewportOnly = false) {
  ...
  //console.log(`📐 RESIZE GL Canvas: ${canvas.width} x ${canvas.height}, display: ${canvas.clientWidth} x ${canvas.clientHeight}`)
}
